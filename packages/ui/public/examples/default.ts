// Welcome to the Deno Playground!
...
const helloWorld = `Hello from Deno v${Deno.version.deno}! 🦕`;
console.log(helloWorld);

// To learn more about the language, click above in "Examples".
// Otherwise, get started by removing these comments and explore the TypeScript & Deno world.
